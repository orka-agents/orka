...
describe('validateWorkspaceRepositoryUrl', () => {
  ...
  it.each([
    ...
    ['loopback IP literal', 'https://127.0.0.1/owner/repo'],
    ['unspecified IP literal', 'https://0.0.0.0/owner/repo'],
    ['link-local IP literal', 'https://169.254.1.1/owner/repo'],
    ['IPv6 loopback literal', 'https://[::1]/owner/repo'],
