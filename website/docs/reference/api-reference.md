...
| `create_agent` | Create an Agent CRD at runtime | `name`, `provider`, `model` (required); `systemPrompt` (role instructions), `soul` (optional persona source), `tools`, `coordination` |
