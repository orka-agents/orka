...
Orka includes 27 CRDs. You create a few resource types, such as Tasks and Agents.
The controller manages the rest to keep track of work across restarts and failures.
