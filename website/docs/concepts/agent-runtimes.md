...
- **`spec.execution.workspace` Task is rejected**: execution-workspace providers are not connected to the ACP core runtime. Use top-level `spec.workspace`; see the deferred [Agent Sandbox](agent-sandbox.md) and [Substrate](substrate.md) pages.
