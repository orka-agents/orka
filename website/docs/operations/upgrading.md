...
This procedure upgrades a current harness v2 installation while preserving its
Tasks, Sessions, SQLite data, and execution recovery records. Apply the target
CRDs before upgrading the controller.
