...
const (
	...
	AnnotationRetryCleanupState             = "orka.ai/retry-cleanup-state"
	AnnotationRetryTaskGeneration           = "orka.ai/retry-task-generation"
	AnnotationRetryAttempt                  = "orka.ai/retry-attempt"
