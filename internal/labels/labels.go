...
const (
	...
	AnnotationForkSourceSession             = "orka.ai/fork-source-session"
	AnnotationForkSourceSeq                 = "orka.ai/fork-source-seq"
	AnnotationForkSourceSessionSeq          = "orka.ai/fork-source-session-seq"
	AnnotationForkContextTruncated          = "orka.ai/fork-context-truncated"
	AnnotationSessionForkRequestDigest      = "orka.ai/session-fork-request-digest"
	AnnotationHarnessEndpoint               = "orka.ai/harness-endpoint"
	AnnotationHarnessEndpointPinned         = "orka.ai/harness-endpoint-pinned"
	AnnotationHarnessProvider               = "orka.ai/harness-provider"
	AnnotationHarnessRuntimeSession         = "orka.ai/harness-runtime-session"
	AnnotationHarnessTurn                   = "orka.ai/harness-turn"
	AnnotationHarnessCorrelation            = "orka.ai/harness-correlation"
	AnnotationHarnessTurnStartedAt          = "orka.ai/harness-turn-started-at"
	AnnotationHarnessTurnIdentityStartedAt  = "orka.ai/harness-turn-identity-started-at"
	AnnotationHarnessBrokeredTools          = "orka.ai/harness-brokered-tools"
	AnnotationHarnessReusePolicy            = "orka.ai/harness-reuse-policy"
	AnnotationHarnessReusePolicyPinned      = "orka.ai/harness-reuse-policy-pinned"
