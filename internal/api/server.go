...
func (s *Server) setupRoutes() {
	...
	if s.hasInternalStores() {
		...
		internal.Get("/tasks/:namespace/:taskName/session-context", s.internalHandlers.GetTaskSessionContext)
		internal.Post("/tasks/:namespace/:taskName/session-context/messages", s.internalHandlers.AppendTaskContextMessages)
		internal.Post("/tasks/:namespace/:taskName/session-context/checkpoints", s.internalHandlers.SaveTaskSessionCheckpoint)
		internal.Get("/tasks/:namespace/:taskName/session-context/history/:messageID", s.internalHandlers.ReadTaskSessionHistory)
