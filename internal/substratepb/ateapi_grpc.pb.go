...
func (UnimplementedControlServer) SuspendActor(context.Context, *SuspendActorRequest) (*SuspendActorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SuspendActor not implemented")
}
func (UnimplementedControlServer) PauseActor(context.Context, *PauseActorRequest) (*PauseActorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PauseActor not implemented")
}
func (UnimplementedControlServer) ResumeActor(context.Context, *ResumeActorRequest) (*ResumeActorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResumeActor not implemented")
}
...
func (UnimplementedControlServer) GetActorEgressPolicy(context.Context, *GetActorEgressPolicyRequest) (*EgressPolicy, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetActorEgressPolicy not implemented")
}
func (UnimplementedControlServer) CreateActorEgressPolicy(context.Context, *CreateActorEgressPolicyRequest) (*EgressPolicy, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateActorEgressPolicy not implemented")
}
func (UnimplementedControlServer) UpdateActorEgressPolicy(context.Context, *UpdateActorEgressPolicyRequest) (*EgressPolicy, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateActorEgressPolicy not implemented")
}
func (UnimplementedControlServer) DeleteActorEgressPolicy(context.Context, *DeleteActorEgressPolicyRequest) (*EgressPolicy, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteActorEgressPolicy not implemented")
}
...
func (UnimplementedControlServer) ListWorkerActorAssignments(context.Context, *ListWorkerActorAssignmentsRequest) (*ListWorkerActorAssignmentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListWorkerActorAssignments not implemented")
}
...
func (UnimplementedControlServer) ListActorTemplates(context.Context, *ListActorTemplatesRequest) (*ListActorTemplatesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListActorTemplates not implemented")
}
func (UnimplementedControlServer) DeleteActorTemplate(context.Context, *DeleteActorTemplateRequest) (*ActorTemplate, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteActorTemplate not implemented")
}
...
func (UnimplementedActorIdentityServer) MintJWT(context.Context, *MintJWTRequest) (*MintJWTResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MintJWT not implemented")
}
func (UnimplementedActorIdentityServer) MintCert(context.Context, *MintCertRequest) (*MintCertResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MintCert not implemented")
}
...
func RegisterActorIdentityServer(s grpc.ServiceRegistrar, srv ActorIdentityServer) {
	// If the following call pancis, it indicates UnimplementedActorIdentityServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedWorkerServiceServer) SetWorkerCapacity(context.Context, *SetWorkerCapacityRequest) (*SetWorkerCapacityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetWorkerCapacity not implemented")
}
