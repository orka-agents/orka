...
commands=(
  ...
  "security" "security repo" "security repo list" "security repo get" "security repo create" "security repo update" "security repo delete" "security scan" "security scan run" "security scan list" "security scan bundle" "security scan coverage" "security scan check" "security threat-model" "security threat-model get" "security threat-model update" "security finding" "security finding list" "security finding get" "security finding dismiss" "security finding reopen" "security finding validate" "security finding patch" "security finding patches" "security finding pr" "security finding occurrences" "security finding decisions" "security finding assessments" "security slice" "security slice list" "security slice get" "security dropped-findings" "security dropped-findings list"
