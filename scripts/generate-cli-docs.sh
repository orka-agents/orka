...
commands=(
  ...
  "memory" "memory list" "memory get" "memory create" "memory update" "memory delete" "memory enable" "memory disable"
  "memory backend" "memory backend list" "memory backend get" "memory backend status" "memory backend create" "memory backend update" "memory backend delete" "memory backend activate" "memory backend decommission" "memory backend force-orphan" "memory backend restore-legacy"
  "memory operation" "memory operation list" "memory operation get" "memory operation retry" "memory operation abandon"
  "memory proposal" "memory proposal list" "memory proposal get" "memory proposal review" "memory proposal apply" "memory proposal archive"
