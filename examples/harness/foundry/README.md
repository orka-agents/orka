...
| `ORKA_FOUNDRY_ENDPOINT` | Foundry agents endpoint base URL. |
...
The unit tests use a fake Foundry-compatible HTTP server and run observed plus brokered-read conformance probes.
